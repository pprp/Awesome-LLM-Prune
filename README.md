...
- Dropping Experts, Recombining Neurons: Retraining-Free Pruning for   Sparse Mixture-of-Experts LLMs
    - Label: <img src=https://img.shields.io/badge/pruning-turquoise.svg >
    - Author: Yixiao Zhou, Ziyu Zhao, Dongzhou Cheng, et al.
    - Link: http://arxiv.org/pdf/2509.10377v1 
    - Code: Not available
    - Pub: Arxiv 2025
...
- A Sentinel-3 foundation model for ocean colour
    ...
    - Code: Not available
    - Pub: Arxiv 2025
    - Summary: This paper introduces a Prithvi-EO Vision Transformer foundation model pre-trained on Sentinel-3 OLCI data for ocean color reconstruction, demonstrating its effectiveness in downstream tasks like chlorophyll concentration estimation and primary production assessment. The model excels in leveraging limited labeled data and capturing detailed spatial patterns, outperforming existing baselines and showcasing the potential of geospatial AI for ocean monitoring and climate research. #FoundationModels #OceanColor #RemoteSensing #VisionTransformer #SelfSupervisedLearning
    - 摘要: 这篇论文介绍了一个新的海洋色彩基础模型，该模型基于Prithvi-EO Vision Transformer架构，并使用Sentinel-3 OLCI数据进行预训练，用于数据重建。通过在叶绿素浓度量化和海洋初级生产力评估两个下游任务上进行微调，结果表明该模型在利用少量高质量标注数据和捕捉海洋色彩的详细空间模式方面具有优势，为海洋监测提供了更可靠的数据驱动的洞察力。

#海洋色彩 #基础模型 #VisionTransformer #Sentinel-3 #自监督学习
