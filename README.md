...
- MSRS: Evaluating Multi-Source Retrieval-Augmented Generation
    ...
    - 摘要: 该研究提出了一个评估多源检索增强生成（RAG）系统的新框架，重点关注系统整合和总结分散在多个来源的信息的能力。通过构建MSRS-Story和MSRS-Meet两个新基准，研究发现生成质量高度依赖于检索效果，且多源信息整合对现有RAG系统构成挑战，但推理模型在这一步骤中表现优于标准LLM。#检索增强生成 #多源信息整合 #RAG评估 #长文本生成    - Label: <img src=https://img.shields.io/badge/semi_structured-brightgreen.svg > <img src=https://img.shields.io/badge/structured-blue.svg >
