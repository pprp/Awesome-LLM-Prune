...
- MSRS: Evaluating Multi-Source Retrieval-Augmented Generation
    ...
    - Code: Not available
    - Pub: Arxiv 2025
    - Summary: This paper introduces a new framework and two benchmarks, MSRS-Story and MSRS-Meet, to evaluate Retrieval-Augmented Generation (RAG) systems in multi-source information integration and long-form response generation scenarios. The study reveals that generation quality heavily relies on retrieval effectiveness, with reasoning models outperforming standard LLMs in synthesizing information from multiple retrieved sources, even with oracle retrieval. #RAG #RetrievalAugmentedGeneration #MultiSource #Evaluation #LLM
    - 摘要: 这篇论文提出了一个评估多源检索增强生成（RAG）系统的新框架，专注于评估系统整合和总结分散在多个来源的信息的能力，以生成长篇回复。作者构建了两个新的基准测试 MSRS-Story 和 MSRS-Meet，分别代表叙事合成和总结任务，实验表明生成质量高度依赖于检索效果，且推理模型在多源合成方面优于标准LLM。#检索增强生成 #多源信息整合 #长文本生成 #评估基准    - Label: <img src=https://img.shields.io/badge/semi_structured-brightgreen.svg > <img src=https://img.shields.io/badge/structured-blue.svg >
